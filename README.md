...
### [Capítulo V: Solution UI/UX Design](#capítulo-iv-solution-software-design)
- [5.1. Style Guidelines](#41-strategic-level-domain-driven-design)
    - [5.1.1. General Style Guidelines](#411-eventstorming)
    - [5.1.2. Web, Mobile and IoT Style Guidelines](#412-context-mapping)
- [5.2. Information Architecture](#42-tactical-level-domain-driven-design)
    - [5.2.1. Organization Systems](#421-bounded-context-1)
    - [5.2.2. Labeling Systems](#421-bounded-context-1)
    - [5.2.3. SEO Tags and Meta Tags](#421-bounded-context-1)
    - [5.2.4. Searching Systems](#421-bounded-context-1)
    - [5.2.5. Navigation Systems](#421-bounded-context-1)
- [5.3. Landing Page UI Design](#42-tactical-level-domain-driven-design)
    - [5.3.1. Landing Page Wireframe](#421-bounded-context-1)
    - [5.3.2. Landing Page Mock-up](#421-bounded-context-1)
- [5.4. Applications UX/UI Design](#42-tactical-level-domain-driven-design)
    - [5.4.1. Applications Wireframes](#421-bounded-context-1)
    - [5.4.2. Applications Wireflow Diagrams](#421-bounded-context-1)
    - [5.4.3. Applications Mock-ups](#421-bounded-context-1)
    - [5.4.4. Applications User Flow Diagrams](#421-bounded-context-1)
- [5.5. Applications Prototyping](#42-tactical-level-domain-driven-design)

### [Capítulo VI: Product Implementation, Validation & Deployment](#capítulo-iv-solution-software-design)
- [6.1. Software Configuration Management](#41-strategic-level-domain-driven-design)
    - [6.1.1. Software Development Environment Configuration](#411-eventstorming)
    - [6.1.2. Source Code Management](#412-context-mapping)
    - [6.1.3. Source Code Style Guide & Conventions](#412-context-mapping)
    - [6.1.4. Software Deployment Configuration](#412-context-mapping)
- [6.2. Landing Page, Services & Applications Implementation](#42-tactical-level-domain-driven-design)
    - [6.2.1. Sprint 1](#421-bounded-context-1)
        - [6.2.1.1. Sprint Planning 1](#4211-domain-layer)
        - [6.2.1.2. Aspect Leaders and Collaborators](#4211-domain-layer)
        - [6.2.1.3. Sprint Backlog 1](#4211-domain-layer)
        - [6.2.1.4. Development Evidence for Sprint Review](#4211-domain-layer)
        - [6.2.1.5. Testing Suite Evidence for Sprint Review](#4211-domain-layer)
        - [6.2.1.6. Execution Evidence for Sprint Review](#4211-domain-layer)
        - [6.2.1.7. Services Documentation Evidence for Sprint Review](#4211-domain-layer)
        - [6.2.1.8. Software Deployment Evidence for Sprint Review](#4211-domain-layer)
        - [6.2.1.9. Team Collaboration Insights during Sprint](#4211-domain-layer)
